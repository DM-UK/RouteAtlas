...
/** Renders a RouteAtlas page taking into account whether the specified map is an overview page or not. */
public class AtlasMapRenderer extends MapRenderer {
    ...
    private void drawAttribution() {
        ...
        GraphicsUtils.drawAlignedString(g2d, mapRenderSettings.getAttribution(), image.getWidth(), image.getHeight(), GraphicsUtils.HAlign.RIGHT, GraphicsUtils.VAlign.ABOVE);
    }
    ...
    private void drawPageTitle() {
        ...
        GraphicsUtils.drawAlignedString(g2d, getTitle(), 0, 0, GraphicsUtils.HAlign.LEFT, GraphicsUtils.VAlign.BELOW);
    }
    ...
    private void drawPageBounds(){
        ...
        for (int i = 1; i < atlas.getAllPages().size(); i++){
            ...
            String indexStr = ""+i;
            GraphicsUtils.drawAlignedString(g2d, indexStr, (int) pageBounds.getCenterX(), (int) pageBounds.getCenterY(), GraphicsUtils.HAlign.CENTRE, GraphicsUtils.VAlign.MIDDLE);
        }
    }
    ...
    public record Marker(String text, Color colour, int radius, float lineThickness){
        public void draw(Graphics2D g2d, Point p){
            ...
            g2d.setColor(Color.black);
            GraphicsUtils.drawAlignedString(g2d, text, p.x, p.y, GraphicsUtils.HAlign.CENTRE, GraphicsUtils.VAlign.MIDDLE);
            //outline
